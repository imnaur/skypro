...
def test_mask_account_card(inp, expected):
...
@pytest.mark.parametrize("inp", [
    ...
    "1234",
    "abcd",
    "53546488288645363672526273838393"
])
def test_mask_account_card_invalid(inp):
...
def test_get_date_valid(inp, expected):
